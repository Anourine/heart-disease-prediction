...
def preprocess_input_data(input_data, label_encoders):
    ...
    categorical_cols = ['Gender', 'Chest Pain Type', 'Family History', 'Smoking', 
                       'Obesity', 'Alcohol Consumption', 'Exercise Hours Per Week', 
                       'Diet', 'Previous Heart Problems', 'Medication Use', 
                       'Stress Level', 'Sedentary Hours Per Day', 'Country', 
...
def show_prediction_page(model, scaler, label_encoders):
    ...
    with st.form("prediction_form"):
        ...
        with col2:
            exercise_hours = st.selectbox("Exercise Hours Per Week", ["0-1", "1-3", "3-5", "5+"])
            ...
            sedentary_hours = st.selectbox("Sedentary Hours Per Day", ["0-4", "4-8", "8-12", "12+"])
            ...
            country = st.selectbox("Country", ["USA", "UK", "Canada", "Australia", "Germany", "France", "Other"])
            continent = st.selectbox("Continent", ["North America", "Europe", "Asia", "Africa", "South America", "Oceania"])

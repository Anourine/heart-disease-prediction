...
def show_prediction_page(model, scaler, label_encoders):
    ...
    with st.form("prediction_form"):
        ...
        with col1:
            ...
            exercise = st.selectbox("Exercise Habits", ["Regular", "Irregular", "None"])
        ...
        with col2:
            ...
            sleep_hours = st.number_input("Sleep Hours", min_value=3, max_value=12, value=8)
            ...
            crp_level = st.number_input("CRP Level", min_value=0.0, max_value=10.0, value=1.0)
            homocysteine_level = st.number_input("Homocysteine Level", min_value=5.0, max_value=20.0, value=10.0)
